...
const UserDetails = () => {
    ...
    let { userInfo, setUserInfo } = useContext(MyContext)
        ...
        <div className="p-5 overflow-x-hidden">
            ...
            <div className='custom_glassy_effect      h-max w-60% mt-40 rounded-xl flex items-center sm:items-start sm:justify-start flex-col sm:flex-row relative pt-14  '>
                ...
                <div className="h-max w-max p-5">
                    ...
                    <h1 className='h-max w-72 text-wrap break-words whitespace-normal font-bold text-lg' >Name: <span className='font-normal text-[15px] text-zinc-800'> {userInfo?.name}</span></h1>
                    <h1 className='h-max w-72 text-wrap break-words whitespace-normal font-bold text-lg'>Phone No: <span className='font-normal text-[15px] text-zinc-800'>{userInfo?.phoneNo}</span> </h1>
                    <h1 className='h-max w-72 text-wrap break-words whitespace-normal font-bold text-lg'>Email: <span className='font-normal text-[15px] text-zinc-800'>{userInfo?.email}</span></h1>
                    <h1 className='h-max w-72 text-wrap break-words whitespace-normal font-bold text-lg'>Address: <span className='font-normal text-[15px] text-zinc-800'>{userInfo?.address}</span></h1>
                    <h1 className='h-max w-72 text-wrap break-words whitespace-normal font-bold text-lg flex'>Password: <span className='w-[90%] font-normal text-[15px] text-zinc-800 break-words whitespace-normal'> {userInfo?.password}</span></h1>
